...
var Tip = React.createClass({
  ...
  render() {
    ...
    if (random === 0) {
      return (
        <p>🖖 Inbox.Video is an open source project, let's <a href="javascript:void(0)" onClick={this.clickLink.bind(this, 'https://github.com/inboxvideo/inbox.video')}>build it together</a>.</p>
      );
    } else if (random === 1){
      return (
